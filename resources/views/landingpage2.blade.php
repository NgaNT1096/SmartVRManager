...
<head>
    ...
    <link rel="stylesheet" href="css/template/magnific-popup.css">
...
<body data-spy="scroll" data-target=".mainmenu-area">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="primary_menu">
                <ul class="nav navbar-nav mainmenu">
                    ...
                    <li><a href="#about_page">Devices</a></li>
                    <li><a href="#features_page">Price</a></li>
                    <li><a href="#gallery_page">About Us</a></li>
                </ul>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 hidden-sm col-md-5">
                    <figure class="mobile-image wow fadeInUp" data-wow-delay="0.2s">
                        <img src="images/template/header-mobile.png" alt="">
                    </figure>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-10 col-md-offset-1">
                    <div class="page-title text-center">
                        <img src="images/template/about-logo.png" alt="About Logo">
                        <div class="space-20"></div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6">
                    <figure class="mobile-image">
                        <img src="images/template/progress-phone.png" alt="">
                    </figure>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-md-6">
                    <div class="video-photo">
                        <img src="images/template/video-image.jpg" alt="">
                        <a href="https://www.youtube.com/watch?v=ScrDhTsX0EQ" class="popup video-button">
                            <img src="images/template/play-button.png" alt="">
                        </a>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="hidden-xs hidden-sm col-md-4">
                    <figure class="mobile-image">
                        <img src="images/template/feature-image.png" alt="Feature Photo">
                    </figure>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="service-box wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="team-slide">
                        <div class="team-box">
                            <div class="team-image">
                                <img src="images/template/team-1.png" alt="">
                            </div>
                        ...
                        <div class="team-box">
                            <div class="team-image">
                                <img src="images/template/team-2.jpg" alt="">
                            </div>
                            <h4>Ashekur Rahman</h4>
                            <h6 class="position">Art Dirrector</h6>
                            <p>Lorem ipsum dolor sit amet, conseg sed do eiusmod temput laborelaborus ed sed do eiusmod tempo.</p>
                        ...
                        <div class="team-box">
                            <div class="team-image">
                                <img src="images/template/team-3.jpg" alt="">
                            </div>
                            <h4>Ashekur Rahman</h4>
                            <h6 class="position">Art Dirrector</h6>
                            <p>Lorem ipsum dolor sit amet, conseg sed do eiusmod temput laborelaborus ed sed do eiusmod tempo.</p>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 gallery-slider">
                    <div class="gallery-slide">
                        <div class="item"><img src="images/template/gallery-1.jpg" alt=""></div>
                        <div class="item"><img src="images/template/gallery-2.jpg" alt=""></div>
                        <div class="item"><img src="images/template/gallery-3.jpg" alt=""></div>
                        <div class="item"><img src="images/template/gallery-4.jpg" alt=""></div>
                        <div class="item"><img src="images/template/gallery-1.jpg" alt=""></div>
                        <div class="item"><img src="images/template/gallery-2.jpg" alt=""></div>
                        <div class="item"><img src="images/template/gallery-3.jpg" alt=""></div>
                        <div class="item"><img src="images/template/gallery-1.jpg" alt=""></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 hidden-sm">
                    <figure class="mobile-image">
                        <img src="images/template/download-image.png" alt="">
                    </figure>
                </div>
                <div class="col-xs-12 col-md-6 section-padding">
                    ...
                    <div class="space-60"></div>
                    <a href="#" class="bttn-white sq"><img src="images/template/apple-icon.png" alt="apple icon"> Apple Store</a>
                    <a href="#" class="bttn-white sq"><img src="images/template/play-store-icon.png" alt="Play Store Icon"> Play Store</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Footer-Area-End -->
    <!--Vendor-JS-->
    <script src="js/template/vendor/jquery-1.12.4.min.js"></script>
    <script src="js/template/vendor/jquery-ui.js"></script>
    <script src="js/template/vendor/bootstrap.min.js"></script>
    <!--Plugin-JS-->
    <script src="js/template/owl.carousel.min.js"></script>
    <script src="js/template/contact-form.js"></script>
    <script src="js/template/ajaxchimp.js"></script>
    <script src="js/template/scrollUp.min.js"></script>
    <script src="js/template/magnific-popup.min.js"></script>
