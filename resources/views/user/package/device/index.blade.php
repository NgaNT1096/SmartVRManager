...
@section('content')
    ...
    <p>
        <a href="{{ route('admin.device.create') }}" class="btn btn-success">@lang('global.app_add_new')</a>
    </p>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body table-responsive">
            <table class="table table-bordered table-striped {{ count($devices) > 0 ? 'datatable' : '' }} dt-select">
                <thead>
                    <tr>
                        <th style="text-align:center;"><input type="checkbox" id="select-all" /></th>
                        <th>@lang('global.device.name')</th>
                        <th>@lang('global.device.des')</th>
                        <th>@lang('global.device.status')</th>
                        <th>&nbsp;</th>
